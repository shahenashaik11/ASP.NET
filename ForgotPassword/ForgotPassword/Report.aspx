<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="ForgotPassword.Report" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: #990033">To Date:</span>&nbsp;
    ...
    <p>
        ...
        <asp:GridView ID="GridView1" runat="server" DataKeyNames="UserID" AutoGenerateSelectButton="True" AutoGenerateColumns="False"   Width="503px" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" style="margin-top: 6px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1"  >
            <Columns>
